...
⠀⠀⠀⠀⠀⠀⠀⠿⠀⠀⠀⠀⠀⠀⠀⠀
┌───────────────────────────────────────────────┐
│            [1] DDoS  berdasarkan alamat IP             │
├───────────────────────────────────────────────┤
│            [2] Dapatkan alamat IP по URL               │
├───────────────────────────────────────────────┤
│            [3] Log serangan DDoS                      │
└───────────────────────────────────────────────┘
"""
...
op = int(input(f'{color_code["dark"]}[✿] Pilih tindakan => {color_code["reset"]}'))
...
if(op == 1):
    ...
    print ("\033[1;31;40m Masukan tidak valid. Memuat ulang alat!") 
    time.sleep(1.6)
    os.system("cd")
